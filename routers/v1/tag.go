...
import (
	"github.com/Stonelalala/go-bin-example/models"
	"github.com/Stonelalala/go-bin-example/pkg/e"
	"github.com/Stonelalala/go-bin-example/pkg/setting"
	"github.com/Stonelalala/go-bin-example/pkg/util"
...
func DeleteTag(c *gin.Context) {
	id := com.StrTo(c.Param("id")).MustInt()
	valid := validation.Validation{}
	valid.Required(id, "id").Message("ID为必须")
